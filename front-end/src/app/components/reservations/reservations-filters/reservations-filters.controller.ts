...
import { getModelFilters } from '../reservations.selectors';

export class ReservationsFiltersComponentController {
  ...
  private _mapStateToThis = (state) => {
    ...
    return this.ReservationsService.mapStateToThisIndex({
